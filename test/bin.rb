...
test "daemon, implicit start" do
  ...
  begin
    ...
    pid = spawn("#{root("bin/nost")} echo", out: w, chdir: "test")
...
test "daemon, explicit start" do
  ...
  begin
    ...
    pid = spawn("#{root("bin/nost")} start echo", out: w, chdir: "test")
...
test "daemonizes" do
  ...
  begin
    pid = spawn("#{root("bin/nost")} -d echo", out: w, chdir: "test")
...
test "gracefully handles TERM signals" do
  ...
  begin
    ...
    pid = spawn("#{root("bin/nost")} -d slow", out: w, chdir: "test")
...
test "stops worker from command line action" do
  ...
  pid = spawn("#{root("bin/nost")} start -d killme", out: w, err: w, chdir: "test")
  ...
  spawn("#{root("bin/nost")} kill killme", chdir: "test")
...
test "use a different dir for pids" do
  ...
  begin
    pid = spawn("#{root("bin/nost")} -d echo -p tmp", out: w, chdir: "test")
